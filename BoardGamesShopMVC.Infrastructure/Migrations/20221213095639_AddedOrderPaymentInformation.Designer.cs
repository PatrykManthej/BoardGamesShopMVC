...
namespace BoardGamesShopMVC.Infrastructure.Migrations
{
    ...
    [Migration("20221213095639_AddedOrderPaymentInformation")]
    partial class AddedOrderPaymentInformation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BoardGamesShopMVC.Domain.Model.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "a2c79527-1fc4-460c-8187-ab5a0ac31c24",
                            Email = "admin1@test.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN1@TEST.COM",
                            NormalizedUserName = "ADMIN1@TEST.COM",
                            PasswordHash = "AQAAAAEAACcQAAAAEDUdLMmG6u5BBgrakV5mFR1FQG6SaC3cJeii8irDyRIdZ9p+EGU+kxeaM/8eq7Hy1A==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "97703d40-3b21-4e6b-89b2-9074f45e125c",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "4db98f12-96ac-4c2f-a3e6-689a39f13e4b",
                            Email = "user1@test.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "USER1@TEST.COM",
                            NormalizedUserName = "USER1@TEST.COM",
                            PasswordHash = "AQAAAAEAACcQAAAAEK+W+N9nUwM7wU3t4UO4MXJskdTF5pmjGT7v4e40KMR1GuCgtjKixFVDaQBaA0rILQ==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "df9cd81f-17dd-46ae-a0e8-7c6ea3333ceb",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("BoardGamesShopMVC.Domain.Model.OrderRecipient", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "Admin",
                            ConcurrencyStamp = "cf9d4c9f-44c5-4771-8a3c-d96dd0160655",
                            Name = "Admin",
                        ...
                        {
                            Id = "Employee",
                            ConcurrencyStamp = "ced49558-c8b7-4d7d-9c66-ce043e650b66",
                            Name = "Employee",
                        ...
                        {
                            Id = "User",
                            ConcurrencyStamp = "abffd935-bdca-4ba6-ba63-a09b05fa9fd9",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("BoardGamesShopMVC.Domain.Model.OrderRecipient", b =>
                {
                    b.HasOne("BoardGamesShopMVC.Domain.Model.Order", "Order")
                        ...
                        .HasForeignKey("BoardGamesShopMVC.Domain.Model.OrderRecipient", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
