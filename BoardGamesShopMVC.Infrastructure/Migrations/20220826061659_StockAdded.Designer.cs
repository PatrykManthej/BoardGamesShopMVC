...
namespace BoardGamesShopMVC.Infrastructure.Migrations
{
    ...
    [Migration("20220826061659_StockAdded")]
            ...
            modelBuilder.Entity("BoardGamesShopMVC.Domain.Models.BoardGame", b =>
                {
                    ...
                    b.HasOne("BoardGamesShopMVC.Domain.Models.Stock", "Stock")
                        .WithOne("BoardGame")
                        .HasForeignKey("BoardGamesShopMVC.Domain.Models.BoardGame", "StockId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
